...
public class Cube {
    ...
    public Cube(){
        ...
        facets[0] = new Facet(new R3Vector(0,0,0),
                ...
                new R3Vector(1,1,0),
                new R3Vector(0,1,0));
        facets[0].set_color(Color.yellow);
        //правая грань
        facets[1] = new Facet(new R3Vector(1,0,1),
                new R3Vector(1,1,1),
                new R3Vector(1,1,0),
                new R3Vector(1,0,0));
        facets[1].set_color(Color.black);
        //левая грань
        facets[2] = new Facet(new R3Vector(0,0,0),
                new R3Vector(0,1,0),
                new R3Vector(0,1,1),
                new R3Vector(0,0,1));
        facets[2].set_color(Color.blue);
        //нижняя грань
        ...
        facets[4] = new Facet(new R3Vector(0,1,0),
                ...
                new R3Vector(1,1,1),
                new R3Vector(0,1,1));
        facets[4].set_color(Color.cyan);
        //передняя грань
        facets[5] = new Facet(new R3Vector(0,0,1),
                new R3Vector(0,1,1),
                new R3Vector(1,1,1),
                new R3Vector(1,0,1));
        facets[5].set_color(Color.green);
    }
